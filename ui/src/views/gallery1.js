  ...
  return (
    <div className="gallery1-container">
      ...
      <header data-role="Header" className="gallery1-header">
        <div data-role="MobileMenu" className="gallery1-mobile-menu">
          ...
          <div>
            ...
            <svg
              ...
              className="gallery1-icon6"
            >
              <path d="M548 6.857v150.857h-89.714c-70.286 0-83.429 33.714-83.429 82.286v108h167.429l-22.286 169.143h-145.143v433.714h-174.857v-433.714h-145.714v-169.143h145.714v-124.571c0-144.571 88.571-223.429 217.714-223.429 61.714 0 114.857 4.571 130.286 6.857z"></path>
            </svg>
          </div>
        </div>
        <span className="gallery1-text">Aniruddha Mandal</span>
        <a
        ...
        <Link to="/contact-me" className="gallery1-navlink">
          Contact Me
        </Link>
      </header>
          ...
          <div className="gallery1-blog-post-card">
            ...
            <div className="gallery1-container03">
              <div className="gallery1-container04">
                <span className="gallery1-text01">Faarms</span>
                <span className="gallery1-text02">3 months</span>
                <span className="gallery1-text03">
                  January 2023 - April 2023
                </span>
              </div>
              <h1 className="gallery1-text04">Python Intern</h1>
              <span className="gallery1-text05">
                <span>
          ...
          <div className="gallery1-blog-post-card1">
            ...
            <div className="gallery1-container07">
              <div className="gallery1-container08">
                ...
                <span className="gallery1-text14">
                  January 2023 - April 2023
                </span>
              </div>
              <h1 className="gallery1-text15">Machine Learning Engineer</h1>
              <span className="gallery1-text16">
              ...
              <div className="gallery1-container09">
                <div className="gallery1-profile1">
                  <span className="gallery1-text17">Remote</span>
                </div>
                <a
              ...
              <span className="gallery1-text18">3 months</span>
            </div>
          </div>
        </div>
        <div className="gallery1-blog-post-card2">
          ...
          <div className="gallery1-container10">
            <div className="gallery1-container11">
              <span className="gallery1-text19">Praxis Business School</span>
              <span className="gallery1-text20">May 2022 - August 2022</span>
            </div>
            <span className="gallery1-text21">4 months</span>
            <div className="gallery1-container12">
              <h1 className="gallery1-text22">Research Intern</h1>
            </div>
            <span className="gallery1-text23">
              <span>
            ...
            <div className="gallery1-container13">
              <div className="gallery1-profile2">
                <span className="gallery1-text27">
